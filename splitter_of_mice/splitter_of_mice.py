...
class SoM:
    ...
    def split_mice(self,outdir,save_analyze=False,num_anim=None,
                   sep_thresh=None,margin=None,minpix=None,output_qc=False,suffix_map=None):
    ...
    def split_mice_ct(self,outdir,desc_map,save_analyze=False,num_anim=None,
        ...
        ims=SoM.add_cuts_to_image(pi,cuts,desc_map,save_analyze_dir)
        #write the images.
    ...
    def standardize_range(im, ignore_min=False, pct=5):
        ...
        print('min,max,rng',mn,mx,rng)
        im1=((im1-mn)/rng)*255
        print('min_new,max_new',np.min(im1),np.max(im1))
        return im1
