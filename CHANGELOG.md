...
- [PIXI-161] - Add consistency between PET and CT cuts -- PET and CT cuts will now be performed in concert.
- [PIXI-162] - Hotel Splitter detecting the wrong number of animals -- adding fixes to ensure that several different reasons for
               failed splits are solved.
- [PIXI-231] - Removing old QC snapshots in the case that the splitter is run again.
